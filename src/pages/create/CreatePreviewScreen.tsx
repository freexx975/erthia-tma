...
import { computeFinalStats, computeMaxHp, computeMaxMp, computeAC, getModifierStr, STAT_KEYS, getNFTRarity, RARITY_LABELS, RARITY_COLORS } from '../../utils/game'
...
export default function CreatePreviewScreen() {
  ...
  // regenLeft salvato nello store come parte della creation
  const regenLeft = creation.regenLeft ?? 10

  const setRegenLeft = (n: number) => {
    useAppStore.setState(s => ({ creation: { ...s.creation, regenLeft: n } }))
  }
